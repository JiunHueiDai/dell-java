...
public class Car extends Vehicle {
	...
	/*
	 * Car constructor to initialize all the car properties and also initialize it
	...
	/*
	 * Method overwrite from parent/super class since Car class has two extra
	 * properties than parent/super class
	 */
